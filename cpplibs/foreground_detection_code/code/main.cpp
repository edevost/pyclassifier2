...
const string mask_save_path = "/run/media/edevost/Tycho/Renards/MasksResults/";
...
float datas;
     ifstream infile;
//float datas;
     infile.open("/run/media/edevost/Tycho/Renards/Softwares/cpplibs/foreground_detection_code/code/params.txt");
     infile >> datas;
     cout << "data" << endl;
     cout << datas << endl;
     infile.close();
